...
def main():
    ...
    parser.add_argument('--output', '-o', type=str, default=None, help='Output directory for results (default: results/test_<timestamp>)')
    ...
    with open(results_path, 'w') as f:
        json.dump(_sanitize_for_json({'average_metrics': avg_metrics, 'model_stats': model_stats, 'per_image_results': results, 'checkpoint': args.checkpoint, 'config': args.config}), f, indent=2, allow_nan=False)
